      ...
      <div className="container mx-auto px-6 lg:px-12 relative">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
            <a
              href="/booking"
              className="btn-neon rounded-full px-8 py-3 text-primary-foreground font-semibold text-sm flex items-center justify-center gap-2 whitespace-nowrap group min-w-[180px]"
            >
              Request Booking
            ...
            <a
              ...
              className="rounded-full px-8 py-3 text-white font-semibold text-sm flex items-center justify-center gap-3 whitespace-nowrap bg-[#20b858] hover:bg-[#1ba94f] transition-colors min-w-[180px]"
            >
