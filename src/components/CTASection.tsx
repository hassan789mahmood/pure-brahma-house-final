        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
            <a
              ...
              className="btn-neon rounded-full px-8 py-4 text-primary-foreground font-semibold text-baseflex items-center justify-center gap-2 group"
            >
              Request Booking
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn-outline rounded-full p8x-8 py-4 text-primary font-semibold text-baseflex items-center justify-center gap-3"
            >
