  ...
  return (
    <footer className="relative pt-24 pb-10 overflow-hidden">
      ...
      <motion.a
        ...
        className="fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full bg-[#20b858] flex items-center justify-center shadow-lg hover:scale-110 transition-transform neon-glow"
      >
