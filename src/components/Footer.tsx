  ...
  return (
    <footer className="relative pt-24 pb-10 overflow-hidden">
      ...
      <motion.a
        ...
        className="fixed bottom-8 right-2 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:scale-110 transition-transform neon-glow"
      >
