            ...
            <div className="flex gap-6">
              {available.map((product, i) => (
                <motion.div
                  ...
                  className="group relative rounded-3xl overflow-hidden border border-border/50 hover:border-primary/40 transition-all duration-500 hover-lift gradient-border bg-card flex-[0_0_calc(50%-12px)] min-w-0 max-sm:flex-[0_0_85%] max-lg:flex-[0_0_85%] flex flex-col"
                >
                  {/* Image */}
