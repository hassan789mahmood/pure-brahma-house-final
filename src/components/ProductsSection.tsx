            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="flex gap-3">
                  <a href="/booking" className="btn-neon rounded-full px-6 py-3 text-sm text-primary-foreground font-semibold flex-1 flex items-center justify-center gap-2 group/btn">
                  ...
                  <a href="https://wa.me/923454489123?text=Hello%20Pure%20Brahma%20House%2C%20I'm%20interested%20in%20your%20Brahma%20birds%20and%20would%20like%20to%20place%20an%20order.%20Please%20share%20further%20information.%20Thank%20you." target="_blank" rel="noopener noreferrer" className="rounded-full px-6 py-3 text-sm text-white font-medium flex-1 flex items-center justify-center gap-2 bg-[#20b858] hover:bg-[#1ba94f] transition-colors">
