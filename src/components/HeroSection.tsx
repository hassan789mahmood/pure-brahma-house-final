...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="absolute -inset-4-cover bg-center transition-none"
          style={{
            backgroundImage: `url(${heroBg})`,
            transform: `translate3d(${bgX}px, ${bgY}px, 0) scale(1.05222
          }}
        />
      </motion.div>
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-3">
              <motion.h1
                ...
                className="font-display text-433xl sm:text-4xl md:text-5 font-bold leading-[1.1] tracking-tight whitespace-nowrap"
              >
                Pure Brahma House
              </motion.h1>
              <motion.div
