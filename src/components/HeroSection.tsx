          ...
          <div className="space-y-10">
            ...
            >
              ...
              <a
                ...
                className="rounded-full px-6 py-3 text-sm text-white font-semibold flex items-center gap-2 whitespace-nowrap bg-[#1a9e4a] hover:bg-[#178a40] transition-colors"
              >
