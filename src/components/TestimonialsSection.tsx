...
const testimonials = [
  ...
  { content: "Received my Isabel Brahma chicks in excellent condition. The feather structure was exactly as described — these birds clearly come from a serious breeding program.", author: "Mujahid Ur Rehman", location: "Lahore, Pakistan", initials: "MR", subtitle: "" },
