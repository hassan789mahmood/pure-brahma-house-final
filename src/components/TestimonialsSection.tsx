...
const testimonials = [
  { content: "Bought 5 month old Isabel Brahma pair from Pure Brahma House and absolutely love them! Healthy, stunning birds with truly beautiful isabel coloring, exactly as described. Honest Seller, Top Quality, Highly Recommended!", author: "Khurram Khan", location: "Dera Ismail Khan, Pakistan", initials: "KK", subtitle: "Admin Brahma Fanciers Club" },
  { content: "Bought 3 breeder males and one female from Pure Brahma House, very satisfied with the purchase! All four birds are healthy, strong and well structured. The males show excellent breeding potential and the female is beautiful. Honest and Professional Seller, will definitely come back again!", author: "Syed Muhammad Musa Bin Imran", location: "Lahore, Pakistan", initials: "SM", subtitle: "Brahma Hen House" },
  { content: "Received my Isabel Brahma chicks in excellent condition. The feather structure was exactly as described — these birds clearly come from a serious breeding program.", { content: "Received my Isabel Brahma chicks in excellent condition. The feather structure was exactly as described — these birds clearly come from a serious breeding program.", author: "Mujahid Ur Rehman", location: "Islamabad, Pakistan", initials: "MR", subtitle: "" },, location: "Islamabad, Pakistan", initials: "AK", subtitle: "" },
  { content: "The fertile eggs were packed carefully. Hatch rate was satisfying. Communication was professional throughout. Will definitely book again next season.", author: "Salman Raza", location: "Karachi, Pakistan", initials: "SR", subtitle: "" },
  { content: "What impressed me most was the transparency. No inflated claims. They told me exactly what to expect. The chicks matched the description perfectly.", author: "Usman Malik", location: "Faisalabad, Pakistan", initials: "UM", subtitle: "" },
];
